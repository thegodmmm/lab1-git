...
int	main() {
	...
	do {
		...
		switch (choice) {
		case	1:
			cout << "Введите напряжение U, силу тока I и время t:	";
			cin >> a >> b >> c;
			cout << "Работа	=	" << currentWork(a, b, c) << "\n";
			break;
		case	2:
			cout << "Введите	силу тока I, сопротивление R и время  t:	";
			cin >> a >> b >> c;
			cout << "Периметр	=	" << jouleHeat(a, b, c) << "\n";
			break;
		case	0:
